...
\newcommand{\myTitle}{A Search for Lightly Ionizing Particles in the LUX Detector and Research and Development For Future Liquid Xenon Time Projection Chambers\xspace}
\newcommand{\mySubtitle}{Subtitle\xspace}
\newcommand{\myDegree}{Doctor of Philosophy PhD\xspace}
\newcommand{\myName}{Katayun Kamdin\xspace}
...
\newcommand{\myVersion}{Version 0.50\xspace}
...
\usepackage{placeins}
\usepackage{rotating} %used to make some figures landscape
\usepackage{fancyvrb}
%------------------------------------------------			
