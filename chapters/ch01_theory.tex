...
Thus far we have focused only on the astrophysical and cosmological evidence for particle \ac{CDM}. \ac{CDM} plays a central role in the standard model of cosmology, known as $\Lambda$\ac{CDM} (``Lambda'' - \ac{CDM}). In this section, we briefly summarize the standard models of cosmology and particle physics.
