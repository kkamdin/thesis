...
\begin{figure}[ht]
    ...
    \includegraphics[width=5.0in]{figures/radon/222Rn_simple_poster.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=6.0in]{figures/radon/Rnpathways.png}
...
In order to investigate the mobility of radon daughters in liquid xenon, a $^{220}$Rn source was employed (see Figure~\ref{fig:Rn220}). The analogous long lived daughter in this chain, $^{212}$Pb, has a half-life of 10.6~h, making it appropriate for a laboratory test. Investigating pathway 2 in the laboratory by introducing radon in a \ac{LXe} environment will necessarily yield inconclusive results, because it is impossible to tell if the daughter decay of interest plated out before decaying. Therefore, we required the radon daughters to be on a surface.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=5.0in]{figures/radon/Rn_Circulation_Path.png}
...
\begin{figure}[ht]
 ...
 %   \includegraphics[width=5.0in]{figures/radon/220Rn_simple_fastslowchains.png}
     \includegraphics[width=5.0in]{figures/radon/220Rn_simple_poster.png}
...
\hline
\end{tabular}
\caption{Calculations of fiducial volume. Liquid level is taken to be 14 $\pm$ 1~mm. Density of \acs{LXe} near boiling point is 2.9~g/mL.}
\label{T:fiducial}
\end{table}
...
The software cuts used to select $^{212}$Bi alphas and reject all. other slow chain decays are described below: 
\begin{enumerate}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.59\textwidth]{figures/radon/hist_a_label.png} \includegraphics[width=0.4\textwidth]{figures/radon/signalregion_a_label.png}\\
\includegraphics[width=0.59\textwidth]{figures/radon/hist_b_label.png} \includegraphics[width=0.4\textwidth]{figures/radon/signalregion_b_label.png}\\
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=0.59\textwidth]{figures/radon/hist_bkg_label.png} \includegraphics[width=0.4\textwidth]{figures/radon/signalregion_bkg_label.png}\\
\includegraphics[width=0.59\textwidth]{figures/radon/hist_calib_label.png}\includegraphics[width=0.4\textwidth]{figures/radon/signalregion_calib_label.png}\\
...
If beta recoil, not `washing' by the \ac{LXe}, is the cause of radon daughter solubility, then the high rate seen by this study of $^{220}$Rn can be reconciled with the low rate of $^{222}$Rn daughter dissolution seen in large \ac{LXe} experiments.
