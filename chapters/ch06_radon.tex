...
\begin{figure}[hbtp]
\centering
\rotatebox[origin=b]{90}{Dataset A}\subfloat[]{\includegraphics[width=0.6\textwidth]{figures/radon/hist_a.png}} \subfloat[]{ \includegraphics[width=0.4\textwidth]{figures/radon/signalregion_a.png}}\\
\rotatebox[origin=b]{90}{Dataset B}\subfloat[]{\includegraphics[width=0.6\textwidth]{figures/radon/hist_b.png}} \subfloat[]{ \includegraphics[width=0.4\textwidth]{figures/radon/signalregion_b.png}}\\
...
\begin{figure}[hbtp]
\centering
\rotatebox[origin=b]{90}{Dataset C}\subfloat[]{\includegraphics[width=0.6\textwidth]{figures/radon/hist_bkg.png}} \subfloat[]{ \includegraphics[width=0.4\textwidth]{figures/radon/signalregion_bkg.png}}\\
\rotatebox[origin=b]{90}{Dataset D}\subfloat[]{\includegraphics[width=0.6\textwidth]{figures/radon/hist_calib.png}} \subfloat[]{ \includegraphics[width=0.4\textwidth]{figures/radon/signalregion_calib.png}}\\
